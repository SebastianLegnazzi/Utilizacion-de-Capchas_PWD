...
<div class="container-fluid pe-5 ps-5 text-center text-light">
    <div id="que-es">
        <div class="display-4 text-warning">¿Qué es un captcha?</div>
        <div class="lead text-start fs-6 mt-2">
    ...
    <div id="como-funciona">
        <div class="display-4 text-warning">¿Cómo funciona?</div>
        <div class="lead text-start fs-6 mt-2"><p>Los CAPTCHA clásicos, que todavía se se siguen usando en algunas propiedades web, piden a los usuarios que identifiquen letras. Las letras están distorsionadas para que los bots no puedan identificarlas. Para pasar la prueba, los usuarios tienen que interpretar el texto distorsionado, introducir las letras correctas en un campo de formulario y enviar el formulario. Si las letras no coinciden, se les pide a los usuarios que lo vuelvan a intentar. Estas pruebas son habituales en formularios de inicio de sesión, formularios de registro de cuenta, encuestas en línea y páginas de pago en comercios electrónicos.</p>
    ...
    <hr>
    <div id="tipos">
        <div class="display-4 text-warning">Tipos de Captchas</div>
        <div class="lead text-start fs-6 mt-2">
            <h2>TEXTO</h2>
            ...
            <img src="../img/Captcha-texto.png" alt="Ejemplo CAPTCHA tipo texto" height="300px" width="600px">
            <br><br>
            <h2>VISUALES</h2>
            ...
            <img src="../img/Captcha-visual.jpg" alt="Ejemplo CAPTCHA tipo visual" height="300px" width="230px">
            <br><br>
            <h2>PREGUNTAS</h2>
            ...
            <img src="../img/Captcha-preguntas.jpg" alt="Ejemplo CAPTCHA tipo preguntas" height="250px" width="450px">
            <br><br>
            <h2>PROBLEMAS MATEMÁTICOS</h2>
            ...
            <img src="../img/Captcha-problemasMatemáticos.png" alt="Ejemplo CAPTCHA tipo problemas matematicos" height="150px" width="260px">
            <br><br>
            ...
            <img src="../img/Captcha-redes.png" alt="Ejemplo CAPTCHA tipo redes sociales" height="270px" width="240px">
            <br><br>
            ...
            <img src="../img/Captcha-juegoPalabras.jpg" alt="Ejemplo CAPTCHA tipo juego de palabras" height="150px" width="300px">
            <br><br>
            <h2>AUDIO</h2>
            ...
            <img src="../img/Captcha-audio.png" alt="Ejemplo CAPTCHA tipo audio" height="150px" width="300px">
            <br><br>
            <h2>LÍMITE DE TIEMPO</h2>
            ...
            <img src="../img/Captcha-tiempo.png" alt="Ejemplo CAPTCHA tipo límite de tiempo" height="150px" width="250px">
            <br><br>
            <h2>LÚDICOS</h2>
            ...
            <img src="../img/Captcha-ludicos.png" alt="Ejemplo CAPTCHA tipo lúdico" height="150px" width="350px">
            <br><br>
            <h2>CAMPOS OCULTOS</h2>
            ...
            <img src="../img/Captcha-oculto.jpg" alt="Ejemplo CAPTCHA tipo campo oculto" height="200px" width="300px">
        </div>
    </div>
    <hr>
    <div id="comparacion">
        <div class="display-4 text-warning">Comparación</div>
