                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <p>
                                En la imágen a nuestra derecha, vemos un ejemplo donde estamos recibiendo el metodo POST del reCaptcha si recibe información de un input mail.
                                <br>
                    ...
                    <div class="col-md-12">
                        <div class="card-body">
                            <p>
                            <p>Siguiendo con las variables de la primera imagen, tenemos:</p>
                            <span class="bg-dark text-light">$recaptcha_ip =</span> En esta variable guardaremos la IP del servidor como se muetra en la imágen, usando una IP remota colocamos lo mismo <span class="bg-dark text-light">$_SERVER['REMOTE_ADDR'];</span>.
                            <br>
                            <span class="bg-dark text-light">$recaptcha_response =</span> Aquí es donde se guardará la respuesta del Captcha con <span class="bg-dark text-light"> $_POST['g-recaptcha-response'];</span>
                            <br>
                            <span class="bg-dark text-light">$recaptcha =</span> Esta variable contendrá la función<span class="bg-dark text-light"> file_get_contents</span> que mandará a nuestra <span class="bg-dark text-light">$recaptcha_url</span> toda la información anidada de la prueba ReCaptcha para transformarlo a un objeto json.
                            <br>
                            <span class="bg-dark text-light">$atributos =</span> Contendrá la función <span class="bg-dark text-light"> json_decode</span> que transformará el objeto json en un ARRAY. A esta función se le manda como parametros nuestra variable <span class="bg-dark text-light"> $recaptcha</span> separado con una coma "," al valor true.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <p>
                                Por ultimo, veremos la respuestra transcripta del json gracias al <span class="bg-dark text-light">json_decode</span>.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <img class="img-thumbnail" src="../img/Respuesta-json.png" alt="Respuesta json">
                    </div>
                    ...
                    <div class="col-md-12">
                        <img class="img-thumbnail mx-auto d-block mb-2" src="../img/Valido-success.png" alt=""><br>
                        <img class="img-thumbnail mx-auto d-block mb-2" src="../img/Captcha-funciona.png" alt="Prueba ReCaptcha"><br>
                        <img class="img-thumbnail mx-auto d-block" src="../img/Mensaje-valido.png" alt="ReCaptcha valido">
                    </div>
                </div>
            </li>
            <li class="list-group-item">
                <div class="row">
                    <h2 class="display-6 text-center bg-warning">¿En que se diferencia la instalacion del ReCaptcha V3?</h2>
                    <div class="col-md-7">
                        <div class="card-body">
                            <p>
                                En el caso de recaptcha v3 es muy similiar a la instacion de ReCaptcha v2 salvo que durante la instalacion elegimos la opcion reCAPTCHA v3 como muestra la imágen a nuestra derecha.
                            </p>
                            <p>
                                Esto nos dara una <span class="bg-dark  text-light">&lt;Site-Key&gt;</span> distinta, y el codigo que debemos ingresar a la pagina es el mismo descripto en la instalación de ReCaptcha v2.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <img class="img-thumbnail" src="../img/recaptchav3/login_captcha_v3.png" alt="">
                    </div>
                    <div class="col-md-7">
                        <p>
                            Otra cosa que cambia en reCAPTCHA V3 es la validacion en el servidor que ya no se hace en base al atributo <span class="bg-dark  text-light">[success]</span> del objeto json, sino en base a un puntaje que el ReCaptcha v3 evalúa al usuario en base al comportamiento que tuvo en la página. Dicho puntaje va del 0 al 1 y nosotros elegimos el umbral que queremos permitir, por lo general es de 0,5.
                        </p>
                    </div>
                    <div class="col-md-5">
                        <img class="img-thumbnail" src="../img/RecapchaV3Backend.png" alt="">
                    </div>
                </div>
            </li>
        </ul>
